...
public class UserDao {
    ...
    public Pagination<User> getUserByPage(String username, int pageSize, int pageNum) {
	    try (SqlSession session = sqlSessionFactory.openSession()) {
          ...
          List<User> users = session.selectList("com.ygm.MyMapper.getUserByPage", map);
          // countUser 的 XML 用到了参数名 username，须传 Map（单传 String 时 OGNL 里没有 username）
          int count = session.selectOne("com.ygm.MyMapper.countUser", map);
    ...
    public void batchInsertUsers(List<User> users) {
        try (SqlSession session = sqlSessionFactory.openSession(true)) {
            ...
            session.insert("com.ygm.MyMapper.batchAddUsers", params);
        }
    }
    ...
    public void updateUser(User user) {
        try (SqlSession session = sqlSessionFactory.openSession(true)) {
            session.update("com.ygm.MyMapper.updateUser", user);
        }
    }
    ...
    public void deleteUserById(Integer id) {
        try (SqlSession session = sqlSessionFactory.openSession(true)) {
            HashMap<String, Object> map = new HashMap<>();
            map.put("id", id);
            session.delete("com.ygm.MyMapper.deleteUserById", map);
        }
    }
    ...
    public User selectUserById(Integer id) {
        try (SqlSession session = sqlSessionFactory.openSession()) {
            HashMap<String, Object> map = new HashMap<>();
            map.put("id", id);
            return session.selectOne("com.ygm.MyMapper.selectUserById", map);
        }
    }
}
